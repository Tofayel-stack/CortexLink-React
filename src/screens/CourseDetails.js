        ...
        <>
            <Wrapper>
                <section className="my__courses__section px-12 pb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 bg-white rounded-xl shadow-lg box-border p-8">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className=" flex flex-row items-center mt-4" style={{ marginTop: "10%" }}>
                                ...
                                <h3 className="my__courses__students__number text-lg pr-8">{studentsNumber}</h3>
                            </div>
                        ...
                        <div className="col-span-2">
                            <div className=" flex flex-row py-3">
                                <h1 className="flex flex-grow text-gray-500 font-semibold text-2xl">{title}</h1>
                            ...
                            <h3 className="my-4 text-gray-700 text-lg font-bold">Topics Inside This Course</h3>
